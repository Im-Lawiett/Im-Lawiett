...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=RianModss&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Full-Stack%20Developer%20%7C%20Code%20Enjoyer%20%7C%20Problem%20Solver&descAlignY=55&descSize=16" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=22&pause=1000&color=00D4FF&center=true&vCenter=true&width=600&lines=Halo%2C+gw+Rian+%F0%9F%91%8B;Gw+suka+ngoding+sampe+lupa+waktu+%F0%9F%92%BB;JavaScript+%26+Python+adalah+sahabat+gw;Always+learning%2C+never+stopping+%F0%9F%94%A5;Build+something+epic+every+day+%E2%9A%A1" alt="Typing SVG" />
...
const RianModss = {
  ...
  motto      : "Code itu kayak seni — bukan cuma jalan, tapi harus indah",
  kontakGw   : () => "Slide in ke DM aja bro 😄",
};
```
...
> *"Pertama jalan dulu, baru diperbagus — tapi jangan lupa diperbagus."*

> *"Bug bukan musuh. Bug adalah guru yang tidak diminta."*

> *"Stack overflow? Itu perpustakaan gw."*
